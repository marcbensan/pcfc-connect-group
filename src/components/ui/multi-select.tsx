      ...
      >
        <PopoverTrigger asChild>
          <Button
            ...
            className={cn(
              "flex w-full p-1 rounded-md border-2 border border-blue-900 min-h-10 h-auto items-center justify-between bg-inherit hover:bg-inherit [&_svg]:pointer-events-auto",
              className
            )}
          >
