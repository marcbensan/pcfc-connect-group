      ...
      >
        <PopoverTrigger asChild>
          <Button
            ...
            className={cn(
              "flex w-[18rem] p-1 font-caption rounded-xl border-1 border-pcfcprimary min-h-10 h-auto items-center justify-between bg-inherit hover:bg-inherit [&_svg]:pointer-events-auto",
              className
            )}
          >
